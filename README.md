...
В случае, если Вы по каким-либо причинам, не можете выполнить одно из условий райдера, просьба сообщить об этом спикеру.
В случае невыполнения одного из условий райдера, спикер вправе ворчать и ругаться на конференцию в твиттере.

**Технический**

- Ноутбук, с которого можно запустить Keynote презентацию
- Кликер или специально обученный кликать по команде человек
- Экран для демонстрации заметок спикера (presenter notes). Подойдет стойка для ноутбука на сцене или экран дублер, на
  который можно вывести подсказки.

**Бытовой**

- 2 бутылки пива не дешевле 100 рублей за штуку на каждый день конференции. Могут быть оставлены в гостинице,
  спикерской комнате или переданы лично в руки.